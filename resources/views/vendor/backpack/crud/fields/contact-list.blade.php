...
@php
  ...
  //  $contacts = $entry->contacts()->withPivot(['decision_maker', 'role'])->get();
...
{{--            <td>{{ $contact->birthday->format('Y') .' ('.$contact->birthday->diffInYears().')' }}</td>--}}
{{--            <td>{{ $contact->phone }}</td>--}}
{{--            <td>{{ $contact->pivot->role }}</td>--}}
{{--            <td>{{ $contact->pivot->decision_maker ? 'active' : '-' }}</td>--}}
{{--            <td>{{ $contact->country->full_name }}</td>--}}
{{--            <td>--}}
{{--                <a href="#" class="btn btn-sm btn-error" style="color:white" data-style="zoom-out"><span class="ladda-label"><i class="la la-trash"></i> </span></a>--}}
{{--            </td>--}}
{{--        </tr>--}}
{{--    @endforeach--}}
